---
title: "Long-Running Daemon Threads in Winter Boot"
sidebarTitle: "Daemon Threads"
description: "Create supervised background processes with #[DaemonThread] that start with your app, run indefinitely, and restart automatically on crash or out-of-memory error."
---

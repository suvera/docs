---
title: "Configure Your Winter Boot Application"
sidebarTitle: "Configuration"
description: "Set up application.yml, inject properties with #[Value], define beans in #[Configuration] classes, chain multiple property sources, and use fallback syntax for safe defaults."
---
...
```yaml config/application-prod.yml
server:
    port: 80
    address: 0.0.0.0

---
title: "Dependency Injection with PHP 8 Attributes"
sidebarTitle: "Dependency Injection"
description: "Learn how Winter Boot's IoC container discovers beans, wires dependencies with PHP 8 attributes, and gives you programmatic access to the application context."
---
...
The `initMethod` is called right after the bean is constructed. `destroyMethod` is registered with `ShutDownRegistry` and called when the process exits.

---
title: "AOP Guard Sample Application"
sidebarTitle: "AOP guard"
...
<Tabs>
  ...
  <Tab title="aop/RequireCustomHeaderInterceptor.php">
    ...
    class RequireCustomHeaderInterceptor implements WinterAspect {
        ...
        public function begin(AopContext $ctx, AopExecutionContext $exCtx): void {
            ...
            $request = null;
            foreach ($exCtx->getArguments() as $arg) {
  ...
  <Tab title="rest/AopDemoController.php">
    The guarded endpoint. It declares an `HttpRequest` argument so the interceptor can read the incoming headers.
    ...
    class AopDemoController {
        ...
        #[RequireCustomHeader]
        public function secureGreeting(HttpRequest $request): array {
            return [
                'success' => true,

---
title: "Monitor Your App with the Winter Boot Actuator"
sidebarTitle: "Actuator"
description: "Enable built-in HTTP endpoints to inspect beans, configuration, environment, scheduled tasks, health indicators, and application info without writing controller code."
---
...
|---|---|---|
| `beans` | `acme/beans` | Lists all Spring-style beans registered in the application context. |
...
```php DatabaseHealthIndicator.php
...
```php ApplicationInfoContributor.php

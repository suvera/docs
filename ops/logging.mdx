---
title: "Configure Structured Logging in Winter Boot"
sidebarTitle: "Logging"
description: "Add the Wlf4p trait to any class for zero-boilerplate structured logging, then tune log levels per class or namespace using a Monolog-backed logger.yml file."
---

---
title: "Get Started with Winter Boot in Minutes"
sidebarTitle: "Quickstart"
description: "Install Winter Boot via Composer, configure application.yml, write a service bean and REST controller, start the Swoole HTTP server, and test your first API endpoint."
---

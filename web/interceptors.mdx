---
title: "HTTP Interceptors for Pre- and Post-Processing"
sidebarTitle: "Interceptors"
description: "Add cross-cutting concerns like authentication, rate limiting, and audit logging to your Winter Boot app using ControllerInterceptor and HandlerInterceptor."
---
...
<Steps>
  <Step title="Implement HandlerInterceptor">
    ...
    ```php RequestLoggingInterceptor.php
    <?php
...
```php AdminAccessInterceptor.php
<?php

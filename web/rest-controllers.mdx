---
title: "Build REST Controllers with Winter Boot"
sidebarTitle: "REST Controllers"
description: "Turn PHP classes into HTTP handlers using #[RestController], inject dependencies with #[Autowired], and shape responses with the ResponseEntity builder API."
---
